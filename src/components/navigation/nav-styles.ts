...
export const FIXED_BOTTOM_LEFT_NAV_CONTAINER_CLASS = `fixed bottom-6 left-4 z-20 md:bottom-8 md:left-6 lg:hidden ${BOTTOM_NAV_CONTAINER_CLASS}`;

export const FLOATING_SEARCH_BUTTON_BASE_CLASS =
  "fixed bottom-6 z-20 flex h-14 w-14 items-center justify-center rounded-full bg-[var(--color-white-95)] text-[var(--text-primary)] shadow-[0_14px_30px_var(--shadow-black-012)] backdrop-blur-sm transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--color-brand)] focus-visible:ring-offset-2 md:bottom-8 lg:hidden";

export const FLOATING_SEARCH_BUTTON_CLASS = `${FLOATING_SEARCH_BUTTON_BASE_CLASS} right-4 md:right-6`;

export const FLOATING_SEARCH_BUTTON_WITH_CART_CLASS = `${FLOATING_SEARCH_BUTTON_BASE_CLASS} right-20 md:right-24`;
