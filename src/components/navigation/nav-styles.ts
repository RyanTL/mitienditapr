export const BOTTOM_NAV_CONTAINER_CLASS =
  "w-fit rounded-[2.25rem] bg-[var(--surface-muted)] px-4 py-2.5 text-[var(--text-primary)]";
...
export const FLOATING_SEARCH_BUTTON_CLASS =
  "fixed right-20 bottom-6 z-20 flex h-14 w-14 items-center justify-center rounded-full border border-[var(--border-default)] bg-[var(--color-white-95)] text-[var(--text-primary)] shadow-[0_14px_30px_var(--shadow-black-012)] backdrop-blur-sm transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--color-brand)] focus-visible:ring-offset-2 md:bottom-8 md:right-24";
